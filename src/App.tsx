        ...
        <>
          ...
          <div style={{ display: 'flex', gap: 10, flexWrap: 'wrap', alignItems: 'center', marginBottom: 12 }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 6 }} title="예약 시간 범위">
              ...
              <input type="time" step={1800} value={fromTime} onChange={e => setFromTime(e.target.value)} style={tInput} />
              <span style={{ color: '#999' }}>~</span>
              <input type="time" step={1800} value={toTime} onChange={e => setToTime(e.target.value)} style={tInput} />
